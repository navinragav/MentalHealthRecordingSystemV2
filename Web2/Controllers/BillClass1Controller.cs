...
namespace Web2.Controllers
{
    public class BillClass1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "bid,PatientId,pname,Appointment,AppointmentTime,DOB,Gender,Prescription,Amount,Status,cname")] BillClass1 billClass1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "bid,PatientId,pname,Appointment,AppointmentTime,DOB,Gender,Prescription,Amount,Status,cname")] BillClass1 billClass1)
        {
            try
            {
